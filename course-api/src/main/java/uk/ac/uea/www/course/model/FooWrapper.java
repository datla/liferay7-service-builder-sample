...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	@Override
	public int compareTo(uk.ac.uea.www.course.model.Foo foo) {
	...
	public com.liferay.portal.kernel.model.CacheModel
		<uk.ac.uea.www.course.model.Foo> toCacheModel() {

		return _foo.toCacheModel();
	}

	@Override
	public uk.ac.uea.www.course.model.Foo toEscapedModel() {
	...
	@Override
	public uk.ac.uea.www.course.model.Foo toUnescapedModel() {
